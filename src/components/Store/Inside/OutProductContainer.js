...
export default function OutProductContainer({ open, setOpen }) {
          ...
          <div className="flex items-end sm:items-center justify-center min-h-full p-4 text-center sm:p-0 ">
            ...
            >
              ...
              <div className='w-full flex  h-full items-center mt-5'>
                   <p className='  justify-center font-Poppins-SemiBold flex flex-grow text-2xl ml-10'>Out Product</p>
                  <IoIosClose className=' text-4xl  text-black border-[1px] rounded-full cursor-pointer bg-[#E4E7EC] '  onClick={() => close()} />
                ...
                <div className='flex flex-col space-y-5 w-full m-auto mt-10'>
                    <div className='flex space-x-5'>                     
                     ...
                     <div className='w-full break-words border-[#E4E7EC] h-fit bg-[#F9FAFF] flex space-x-2 items-center py-4 px-4    relative m-auto border-[1px] rounded-xl ' >
                        <input name='Quantity' placeholder='Quantity' type="text" className='w-full bg-[#F9FAFF] font-Poppins-Regular text-xs text-[#707070] outline-0 ring-0'/>
                      </div>
